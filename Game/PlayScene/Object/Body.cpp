...
// 戻り値：なし
//--------------------------------------------------------
void Body::AddBossParts(std::unique_ptr<HeartObject> bossParts)
{
	// タンクパーツを追加する
...
// 戻り値：なし
//-------------------------------------------------------
void Body::Initialize(BossFactory* bossFactory)
{
...
// 戻り値：なし
//---------------------------------------------------------------
void Body::Draw(DirectX::CommonStates* commonStates, Camera* camera)
{
	mCamera = camera;
...
//---------------------------------------
DirectX::SimpleMath::Vector3 Body::GetObjectPos() const
{
...
// 戻り値：なし
//---------------------------------------
void Body::SetObjectPos(const DirectX::SimpleMath::Vector3& pos)
{
...
// 戻り値(Vector3)：オブジェクトの座標
//---------------------------------------
DirectX::SimpleMath::Vector3 Body::GetObjectDirection() const
{
...
// 戻り値：なし
//---------------------------------------
void Body::SetObjectDirection(const DirectX::SimpleMath::Vector3& direction)
{
...
//---------------------------------------
DirectX::SimpleMath::Vector3 Body::GetObjectSpeed() const
{
...
// 戻り値：なし
//---------------------------------------
void Body::SetObjectSpeed(const DirectX::SimpleMath::Vector3& speed)
{
