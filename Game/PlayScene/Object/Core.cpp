...
// 戻り値：なし
//-------------------------------------------------------------------
void Core::AddBossParts(std::unique_ptr<HeartObject> bossParts)
{
...
// 戻り値：なし
//----------------------------------------------------
void Core::Initialize(BossFactory* bossFactory)
{
...
// 戻り値：なし
//---------------------------------------------------------------------
void Core::Draw(DirectX::CommonStates* commonStates, Camera* camera)
{
...
// 戻り値：なし
//---------------------------------------
void Core::BulletFire(DirectX::SimpleMath::Vector3 pos)
{
...
//---------------------------------------
DirectX::SimpleMath::Vector3 Core::GetObjectPos() const
{
...
// 戻り値：なし
//---------------------------------------
void Core::SetObjectPos(const DirectX::SimpleMath::Vector3& pos)
{
...
// 戻り値(Vector3)：オブジェクトの座標
//---------------------------------------
DirectX::SimpleMath::Vector3 Core::GetObjectDirection() const
{
...
// 戻り値：なし
//---------------------------------------
void Core::SetObjectDirection(const DirectX::SimpleMath::Vector3& direction)
{
...
//---------------------------------------
DirectX::SimpleMath::Vector3 Core::GetObjectSpeed() const
{
...
// 戻り値：なし
//---------------------------------------
void Core::SetObjectSpeed(const DirectX::SimpleMath::Vector3& speed)
{
...
// 戻り値：なし
//---------------------------------------
void Core::SetActive(const bool& active)
{
