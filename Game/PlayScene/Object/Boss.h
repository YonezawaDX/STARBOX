...
public:
	...
	//! パーツの初期座標（大きい腕）					  
	static const DirectX::SimpleMath::Vector3 ARM_OFFSET_01;
	
	//! パーツの初期座標（小さい腕01）
	static const DirectX::SimpleMath::Vector3 ARM_OFFSET_02;
	
	//! パーツの初期座標（小さい腕02）
	static const DirectX::SimpleMath::Vector3 ARM_OFFSET_03;
...
public:
	...
	*/
	Boss(BulletManager* pBulletManager,EnemyManager* pEnemyManager);
...
private:
	//! 車体オブジェクト
	std::unique_ptr<HeartObject> mpBody;
