/**
* @file CaterpillerRight.cpp
* @brief キャタピタのクラス
* @author 米澤駿介
* @date 2022/05/01
* @details ボス02のタイヤ右のクラス
*/
#include "pch.h"

#include "CaterpillerRight.h"
...
// 戻り値：なし
//--------------------------------------------------------
void CaterpillerRight::AddBossParts(std::unique_ptr<HeartObject> bossParts)
{
	// タンクパーツを追加する
...
// 戻り値：なし
//----------------------------------------------------------
CaterpillerRight::CaterpillerRight(
...
// 戻り値：なし
//-------------------------------------------------------
void CaterpillerRight::Initialize(BossFactory* bossFactory)
{
...
// 戻り値：なし
//---------------------------------------------------------------
void CaterpillerRight::Draw(DirectX::CommonStates* commonStates, Camera* camera)
{
	mCamera = camera;
	...
	pRM->GetCmoModel("CaterpillerRight")->Draw(
		context,
		*commonStates,
...
// 戻り値：なし
//----------------------------------------------
void CaterpillerRight::Finalize()
{
}
...
// 戻り値：なし
//-----------------------------------------------
void CaterpillerRight::Collision()
{
...
// 戻り値：なし
//--------------------------------------------------------
void CaterpillerRight::DeleteParts()
{
...
//---------------------------------------
DirectX::SimpleMath::Vector3 CaterpillerRight::GetObjectPos() const
{
...
// 戻り値：なし
//---------------------------------------
void CaterpillerRight::SetObjectPos(const DirectX::SimpleMath::Vector3& pos)
{
...
// 戻り値(Vector3)：オブジェクトの座標
//---------------------------------------
DirectX::SimpleMath::Vector3 CaterpillerRight::GetObjectDirection() const
{
...
// 戻り値：なし
//---------------------------------------
void CaterpillerRight::SetObjectDirection(const DirectX::SimpleMath::Vector3& direction)
{
...
//---------------------------------------
DirectX::SimpleMath::Vector3 CaterpillerRight::GetObjectSpeed() const
{
...
// 戻り値：なし
//---------------------------------------
void CaterpillerRight::SetObjectSpeed(const DirectX::SimpleMath::Vector3& speed)
{
...
//---------------------------------------
bool CaterpillerRight::GetActive() const
{
...
// 戻り値：なし
//---------------------------------------
void CaterpillerRight::SetActive(const bool& active)
{
...
//---------------------------------------
int CaterpillerRight::GetHP() const
{
...
// 戻り値：なし
//---------------------------------------
void CaterpillerRight::SetHP(const int& hp)
{
