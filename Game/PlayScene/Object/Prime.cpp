...
// 戻り値：なし
//--------------------------------------------------------
void Prime::AddBossParts(std::unique_ptr<HeartObject> bossParts)
{
	// タンクパーツを追加する
...
// 戻り値：なし
//-------------------------------------------------------
void Prime::Initialize(BossFactory* bossFactory)
{
...
// 戻り値：なし
//---------------------------------------------------------------
void Prime::Draw(DirectX::CommonStates* commonStates, Camera* camera)
{
	mCamera = camera;
...
//---------------------------------------
DirectX::SimpleMath::Vector3 Prime::GetObjectPos() const
{
...
// 戻り値：なし
//---------------------------------------
void Prime::SetObjectPos(const DirectX::SimpleMath::Vector3& pos)
{
...
// 戻り値(Vector3)：オブジェクトの座標
//---------------------------------------
DirectX::SimpleMath::Vector3 Prime::GetObjectDirection() const
{
...
// 戻り値：なし
//---------------------------------------
void Prime::SetObjectDirection(const DirectX::SimpleMath::Vector3& direction)
{
...
//---------------------------------------
DirectX::SimpleMath::Vector3 Prime::GetObjectSpeed() const
{
...
// 戻り値：なし
//---------------------------------------
void Prime::SetObjectSpeed(const DirectX::SimpleMath::Vector3& speed)
{
...
// 戻り値：なし
//---------------------------------------
void Prime::SetActive(const bool& active)
{
